...
const svgContent = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" width="512" height="512">
  ...
  <g stroke="#f59e0b" stroke-width="8" stroke-linecap="round" fill="none">
    ...
    <circle cx="70" cy="250" r="12" fill="#f59e0b" />
    <path d="M 420 250 L 340 250" />
    <circle cx="430" cy="250" r="12" fill="#f59e0b" />
  </g>
  <path d="M 250 40 L 410 110 V 270 C 410 375 250 450 250 450 C 250 450 90 375 90 270 V 110 Z" fill="#1e293b" stroke="#38bdf8" stroke-width="12"/>
  <path d="M 250 60 L 390 120 V 260 C 390 355 250 425 250 425 C 250 425 110 355 110 260 V 120 Z" fill="#0f172a" stroke="#0284c7" stroke-width="4"/>
